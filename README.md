...
- Foundational knowledge of JavaScript and programming. But this guide is still beginner-friendly! 👏
- Forked version of this repo so you can mangle it up however you want!<br>![fork repo](/img/fork.png)
...
- My chats in GPT were bogging down.
- The boilerplate prompt construction was annoying to repeat.
- I wanted a more advanced version of GPT.
...
2. Install the packages for this project: `npm install`. This is what you get:
    ...
    "dotenv": "^16.3.1",  
    ```
3. Create a `.env` file to store your API keys in. 
4. Inside your `.env` file, paste your Discord and OpenAI tokens. 
...
One amusing way to deploy this bot is on an Android phone! This is done by using an app called Termux which is a CLI for Android 7+. Follow the step by step guide to install Termux, node.js, and your repo on your phone and run it!
...
- SO... Thankfully, there's a way to communicate with user's that your bot is taking some time to do some thinking. Supply `await interaction.deferReply();` as early as possible. It adds a handy "thinking" notification...
  ...
  ![thinking and defer reply](/img/defer-reply.png)

## Resources
Below are some resources which were really useful in putting this experience together! Things in the AI space change fast, so some guides are outdated, but can serve as really useful references!

- [GPT4 Video Guide](https://www.youtube.com/watch?v=EUlnKW6Yy94)
- [Anthropic's API Docs](https://docs.anthropic.com/claude/reference/getting-started-with-the-api)
